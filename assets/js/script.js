...
/*Part of the API sample is referenced from AccuWeather github - https://github.com/AccuWeather-Inc/AccuWeatherApiSamples/
...
$(function () {
    ...
    var awxCityLookUp = function (freeText) {
        ...
        locationUrl = "http://api.accuweather.com/locations/v1/search?q=" + freeText + "&apikey=" + apiKey;
        $.ajax({
            type: "GET",
            url: locationUrl,
            dataType: "jsonp",
    ...
    // For more info about Current Conditions API go to http://api.accuweather.com/developers/locations
    var awxGetCurrentConditions = function (locationKey) {
        //currentConditionsUrl = "http://apidev.accuweather.com/currentconditions/v1/" + 
        currentConditionsUrl = "http://apid.accuweather.com/currentconditions/v1/" + 
